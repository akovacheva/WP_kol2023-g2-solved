...
public class MoviesController {
    ...
    public String showMovies(@RequestParam(required = false) Double rating, @RequestParam(required = false) Genre genre, Model model) {
        ...
        if (rating == null && genre == null) {
            movie = this.movieService.listAllMovies();
        } else {
           movie = this.movieService.listMoviesWithRatingLessThenAndGenre(rating, genre);
        }
    ...
    public String showAdd(Model model) {
        ...
        List<Director> director = this.directorService.listAll();
