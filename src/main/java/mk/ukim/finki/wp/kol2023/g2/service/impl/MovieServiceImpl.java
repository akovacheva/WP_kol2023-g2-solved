...
public class MovieServiceImpl implements MovieService {
    ...
    public Movie create(String name, String description, Double rating, Genre genre, Long directorId) {
        Director director = this.directorRepository.findById(directorId).orElseThrow(InvalidDirectorIdException::new);
    ...
    public List<Movie> listMoviesWithRatingLessThenAndGenre(Double rating, Genre genre) {
        ...
        {
            return this.movieRepository.findByGenreAndRatingLessThan(genre, rating);
        } else if (rating != null) {
